...
function makeRecipeDisplay(title, image, prep_time, cook_time, ingredients, instructions){
    ...
    html += '<div class="panel panel-default"><div class="panel-heading text-center"><h2>'+recipe_title+'</h2></div>';
    html += '<div class="panel-body"><img class="img-responsive center-block" src="'+image+'" alt="'+recipe_title+'"/>';
